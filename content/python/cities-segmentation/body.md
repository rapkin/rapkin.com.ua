...
- **Aspectum** - сервіс для візуалізації та аналізу картографічної інформації. Можна скористатись і geojson.io, але при великій кількості геометрію можуть виникати проблеми з продуктивністю. Часто можна замінити інтерфейсом QGIS.
...
![Залізнична розв'язка у місті Київ](/assets/img/kiev-simple-bad-geom.png)
...
![FIXME](/assets/img/kiev-simple-bad-geom.png)
![FIXME](/assets/img/kiev-merged-good-geom.png)

А а повне зображення для міста Київ:
