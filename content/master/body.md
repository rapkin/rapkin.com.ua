...
_Невже тут писати, що таке пітон і тд? Можливо, краще вставити більше інформації про проблеми обрахунків великих об'ємів геопросторових даних (неправильна геометрія, індексація, проекція)?_

__Стандарт OSM__

__Геопросторова інформація, види геометрії__

__Опис проблеми неправильної геометрії__

__Оптимізація швидкості обрахунків геопросторових даних, індексація__

__Проекція геометрії в різні системи координат__

__Проблема точності обрахунків__
...
Для побудови буферів слугує функція build_buffer_on_lines, яка виконує побудову квадратного буфера. _буфера/буферу_
